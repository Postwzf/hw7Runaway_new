...
GameManager::GameManager() : m_gameState(GameManager::GameState::TITLE), m_pause(false), m_pressedKeys(), m_mousePos(0, 0)
{
}
...
void GameManager::ShowGameOver() const
{
    ...
    displayText(NormalizeCoord(WINDOW_WIDTH / 2, WINDOW_WIDTH), NormalizeCoord(50, WINDOW_HEIGHT), 0,
                "Your score: [      ] Press Enter to restart.", true, GLUT_BITMAP_HELVETICA_18);
    glPopAttrib();
    glutSwapBuffers();
}
